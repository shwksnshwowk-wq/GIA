    ...
    for randSeed in cycle_number:
        ...
        for num_batch_size, batch_size_temp in enumerate(batch_size):
            ...
            for index_input, temp_input in enumerate(input_encodings['input_ids']):
                temp_input_mask = (temp_input != 50256)  # Format: tensor([1, 2]), Search for fill-in element 151643
            ...
            writer.writerow([randSeed, batch_size_temp, len(Token_index_all), len(true_token)])
            result_file.flush()
